...
public class ImageUploadController {
	@Autowired
	com.shop.restfull.repository.ImageRepository imageRepository;
	@PostMapping("/upload")
	public ResponseEntity uplaodImage(@RequestParam("imageFile") MultipartFile file) throws IOException {
		System.out.println("Original Image Byte Size - " + file.getBytes().length);
		Optional<ImageModel> imgRecuperada = imageRepository.findByName(file.getOriginalFilename());
		if(imgRecuperada.isPresent()) {
			imageRepository.deleteByName(file.getOriginalFilename());
		}
