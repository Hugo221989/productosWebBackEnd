...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.shop.restfull"))
	...
	public ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Nutrición Deportiva Web").description(
				"Esta API define el conjunto de especificaciones de la capa de servicios de Productos Nutricionales Web, orientada a la plataforma del Usuario. "
